...
include_once ('com/alibaba/trade/param/AlibabaTradeSubPayInfo.class.php');
include_once ('com/alibaba/trade/param/AlibabaTradeSpecInfo.class.php');
include_once ('com/alibaba/trade/param/AlibabaTradeCargoImage.class.php');
include_once ('com/alibaba/trade/param/AlibabaTradeOpPromotionInfor.class.php');
...
class AlibabaTradeCargo extends SDKDomain {
    ...
    * @return 是否支持混批
    */
        public function getMixSale() {
        return $this->mixSale;
    }
    
    /**
     * 设置是否支持混批     
     * @param Boolean $mixSale     
     * 参数示例：<pre></pre>     
     * 此参数必填     */
    public function setMixSale( $mixSale) {
    ...
    * @return 混批起批量
    */
        public function getMixBegin() {
        return $this->mixBegin;
    }
    
    /**
     * 设置混批起批量     
     * @param Integer $mixBegin     
     * 参数示例：<pre></pre>     
     * 此参数必填     */
    public function setMixBegin( $mixBegin) {
    ...
    * @return 商品行级别的优惠信息
    */
        public function getProductPromotionInfo() {
        return $this->productPromotionInfo;
    }
    
    /**
     * 设置商品行级别的优惠信息     
     * @param AlibabaTradeOpPromotionInfor $productPromotionInfo     
     * 参数示例：<pre></pre>     
     * 此参数必填     */
    public function setProductPromotionInfo(AlibabaTradeOpPromotionInfor $productPromotionInfo) {
    			...
    			$imagesResult=$this->stdResult->{"images"};
					...
					for($i = 0; $i < count ( $object ); $i ++) {
						...
						$this->images [$i] = $AlibabaTradeCargoImageResult;
    			    		    				    			    			...
    			    		    				    			    			if (array_key_exists ( "mixSale", $this->stdResult )) {
    				$this->mixSale = $this->stdResult->{"mixSale"};
    			}
    			    		    				    			    			if (array_key_exists ( "mixBegin", $this->stdResult )) {
    				$this->mixBegin = $this->stdResult->{"mixBegin"};
    			}
    			    		    				    			    			if (array_key_exists ( "productPromotionInfo", $this->stdResult )) {
    				$productPromotionInfoResult=$this->stdResult->{"productPromotionInfo"};
    				$this->productPromotionInfo = new AlibabaTradeOpPromotionInfor();
    				$this->productPromotionInfo->setStdResult ( $productPromotionInfoResult);
    			}
    			    		    		}
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$subPayInforsResult=$arrayResult['subPayInfors'];
    			$this->subPayInfors = new AlibabaTradeSubPayInfo();
    			$this->subPayInfors->setStdResult ( $subPayInforsResult);
    		}
    		    	    			    		    		if (array_key_exists ( "specInfo", $this->arrayResult )) {
    		$specInfoResult=$arrayResult['specInfo'];
    			$this->specInfo = new AlibabaTradeSpecInfo();
    			$this->specInfo->setStdResult ( $specInfoResult);
    		}
    		    	    			    		    		if (array_key_exists ( "images", $this->arrayResult )) {
    		$imagesResult=$arrayResult['images'];
    			$this->images = new AlibabaTradeCargoImage();
    			$this->images->setStdResult ( $imagesResult);
    		}
    		    	    			    		    			if (array_key_exists ( "mixSale", $this->arrayResult )) {
    			$this->mixSale = $arrayResult['mixSale'];
    			}
    		    	    			    		    			if (array_key_exists ( "mixBegin", $this->arrayResult )) {
    			$this->mixBegin = $arrayResult['mixBegin'];
    			}
    		    	    			    		    		if (array_key_exists ( "productPromotionInfo", $this->arrayResult )) {
    		$productPromotionInfoResult=$arrayResult['productPromotionInfo'];
    			    			$this->productPromotionInfo = new AlibabaTradeOpPromotionInfor();
    			    			$this->productPromotionInfo->setStdResult ( $productPromotionInfoResult);
    		}
    		    	    		}
