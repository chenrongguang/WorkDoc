...
include_once ('com/alibaba/trade/param/AlibabaTradeSimpleBuyer.class.php');
include_once ('com/alibaba/trade/param/AlibabaPaymentPayChannels.class.php');
include_once ('com/alibaba/trade/param/AlibabaTradeSimpleSeller.class.php');
include_once ('com/alibaba/trade/param/AlibabaTradeSimpleSeller.class.php');
include_once ('com/alibaba/trade/param/AlibabaTradeTradeModeModel.class.php');
include_once ('com/alibaba/trade/param/AlibabaTradeToleranceCollection.class.php');
include_once ('com/alibaba/trade/param/AlibabaTradeCargo.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$shopPromotionInfoResult=$arrayResult['shopPromotionInfo'];
    			    			$this->shopPromotionInfo = new AlibabaTradeOpPromotionInfor();
    			    			$this->shopPromotionInfo->setStdResult ( $shopPromotionInfoResult);
    		}
    		    	    		}
