...
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeBizOrderCommitResult.class.php');
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeBizMutilOrderPublicData.class.php');
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeResultCodeDef.class.php');
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeKeyValuePairBizOrderCommitResult.class.php');
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeKeyValuePairBizOrderCommitResult.class.php');
