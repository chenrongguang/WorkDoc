...
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeJsonGoodsParam.class.php');
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeSpecInfo.class.php');
