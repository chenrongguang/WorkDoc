    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->adjustFee = $arrayResult['adjustFee'];
    			}
    			...
    			$this->enterTime = $arrayResult['enterTime'];
    			}
    			...
    			$this->sellerActionTime = $arrayResult['sellerActionTime'];
    			}
    			...
    			$this->messagePath = $arrayResult['messagePath'];
    			}
    		    	    			    		    			if (array_key_exists ( "picturePath", $this->arrayResult )) {
    			$this->picturePath = $arrayResult['picturePath'];
    			}
