...
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeBizSimpleOrderEntryModel.class.php');
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$orderEntryModelResult=$arrayResult['orderEntryModel'];
    			$this->orderEntryModel = new AlibabaOpenplatformTradeBizSimpleOrderEntryModel();
    			$this->orderEntryModel->setStdResult ( $orderEntryModelResult);
    		}
    		    	    		}
