...
include_once ('com/alibaba/trade/param/AlibabaCommonUrl.class.php');
include_once ('com/alibaba/trade/param/AlibabaProductRelateRelationGroupInfo.class.php');
include_once ('com/alibaba/trade/param/AlibabaCommonUrl.class.php');
include_once ('com/alibaba/trade/param/AlibabaTradeItemIn.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->spuId = $arrayResult['spuId'];
    			}
    		    	    			    		    		if (array_key_exists ( "url", $this->arrayResult )) {
    		$urlResult=$arrayResult['url'];
    			    			$this->url = new AlibabaCommonUrl();
    			    			$this->url->setStdResult ( $urlResult);
    		}
    		    	    			    		    		if (array_key_exists ( "relationGroupInfos", $this->arrayResult )) {
    		$relationGroupInfosResult=$arrayResult['relationGroupInfos'];
    			    			$this->relationGroupInfos = new AlibabaProductRelateRelationGroupInfo();
    			    			$this->relationGroupInfos->setStdResult ( $relationGroupInfosResult);
    		}
    		    	    			    		    		if (array_key_exists ( "imgUrls", $this->arrayResult )) {
    		$imgUrlsResult=$arrayResult['imgUrls'];
    		...
    		$relatedItemsResult=$arrayResult['relatedItems'];
    			...
    			$this->buyAlone = $arrayResult['buyAlone'];
    			}
    		    	    		}
