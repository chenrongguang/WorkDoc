...
include_once ('com/alibaba/trade/param/AlibabaTradeRefundOpOrderRefundOperationModel.class.php');
...
3：买家已退货     
    ...
    */
    ...
    /**
     * 设置     
     * @param array include @see AlibabaTradeRefundOpOrderRefundOperationModel[] $refundOperationList     
     * 参数示例：<pre></pre>     
     * 此参数必填     */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->aftersaleAgreeTimeout = $arrayResult['aftersaleAgreeTimeout'];
    			}
    		    	    			    		    			if (array_key_exists ( "aftersaleAutoDisburse", $this->arrayResult )) {
    			$this->aftersaleAutoDisburse = $arrayResult['aftersaleAutoDisburse'];
    			}
    		    	    			    		    			if (array_key_exists ( "alipayPaymentId", $this->arrayResult )) {
    			$this->alipayPaymentId = $arrayResult['alipayPaymentId'];
    			}
    			...
    			$this->applyExpect = $arrayResult['applyExpect'];
    			}
    			...
    			$this->asynErrCode = $arrayResult['asynErrCode'];
    			}
    		    	    			    		    			if (array_key_exists ( "asynSubErrCode", $this->arrayResult )) {
    			$this->asynSubErrCode = $arrayResult['asynSubErrCode'];
    			}
    			...
    			$this->buyerLogisticsName = $arrayResult['buyerLogisticsName'];
    			}
    			...
    			$this->disburseChannel = $arrayResult['disburseChannel'];
    			}
    			...
    			$this->extInfo = $arrayResult['extInfo'];
    			}
    			...
    			$this->frozenFund = $arrayResult['frozenFund'];
    			}
    			...
    			$this->gmtFreezed = $arrayResult['gmtFreezed'];
    			}
    			...
    			$this->gmtTimeOut = $arrayResult['gmtTimeOut'];
    			}
    			...
    			$this->goodsStatus = $arrayResult['goodsStatus'];
    			}
    		    	    			    		    			if (array_key_exists ( "id", $this->arrayResult )) {
    			$this->id = $arrayResult['id'];
    			}
    		    	    			    		    			if (array_key_exists ( "instantRefundType", $this->arrayResult )) {
    			$this->instantRefundType = $arrayResult['instantRefundType'];
    			}
    		    	    			    		    			if (array_key_exists ( "insufficientAccount", $this->arrayResult )) {
    			$this->insufficientAccount = $arrayResult['insufficientAccount'];
    			}
    		    	    			    		    			if (array_key_exists ( "insufficientBail", $this->arrayResult )) {
    			$this->insufficientBail = $arrayResult['insufficientBail'];
    			}
    		    	    			    		    			if (array_key_exists ( "newRefundReturn", $this->arrayResult )) {
    			$this->newRefundReturn = $arrayResult['newRefundReturn'];
    			}
    		    	    			    		    			if (array_key_exists ( "onlyRefund", $this->arrayResult )) {
    			$this->onlyRefund = $arrayResult['onlyRefund'];
    			}
    		    	    			    		    			if (array_key_exists ( "orderEntryCountMap", $this->arrayResult )) {
    			$this->orderEntryCountMap = $arrayResult['orderEntryCountMap'];
    			}
    			...
    			$this->prepaidBalance = $arrayResult['prepaidBalance'];
    			}
    			...
    			$this->rejectReasonId = $arrayResult['rejectReasonId'];
    			}
    		    	    			    		    			if (array_key_exists ( "rejectTimes", $this->arrayResult )) {
    			$this->rejectTimes = $arrayResult['rejectTimes'];
    			}
    			...
    			$this->sellerDelayDisburse = $arrayResult['sellerDelayDisburse'];
    			}
    			...
    			$this->sellerRealName = $arrayResult['sellerRealName'];
    			}
    		    	    			    		    			if (array_key_exists ( "sellerReceiveAddress", $this->arrayResult )) {
    			$this->sellerReceiveAddress = $arrayResult['sellerReceiveAddress'];
    			}
    		    	    			    		    			if (array_key_exists ( "sellerTel", $this->arrayResult )) {
    			$this->sellerTel = $arrayResult['sellerTel'];
    			}
    			...
    			$this->supportNewSteppay = $arrayResult['supportNewSteppay'];
    			}
    			...
    			$this->timeOutFreeze = $arrayResult['timeOutFreeze'];
    			}
    		    	    			    		    			if (array_key_exists ( "timeOutOperateType", $this->arrayResult )) {
    			$this->timeOutOperateType = $arrayResult['timeOutOperateType'];
    			}
    		...
    		$refundOperationListResult=$arrayResult['refundOperationList'];
