...
include_once ('com/alibaba/trade/param/AlibabaCommonUrl.class.php');
include_once ('com/alibaba/trade/param/AlibabaProductUnitPrice.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->unitOfMeasure = $arrayResult['unitOfMeasure'];
    			}
    		    	    			    		    		if (array_key_exists ( "imgUrl", $this->arrayResult )) {
    		$imgUrlResult=$arrayResult['imgUrl'];
    		...
    		$unitPriceResult=$arrayResult['unitPrice'];
    			    			$this->unitPrice = new AlibabaProductUnitPrice();
    			    			$this->unitPrice->setStdResult ( $unitPriceResult);
    		}
    		    	    		}
