...
include_once ('com/alibaba/trade/param/AlibabaProductProductItemInfo.class.php');
include_once ('com/alibaba/trade/param/AlibabaProductItemIDDefinition.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$productItemInfosResult=$arrayResult['productItemInfos'];
    		...
    		$idOfSupplierResult=$arrayResult['idOfSupplier'];
    			    			$this->idOfSupplier = new AlibabaProductItemIDDefinition();
    			    			$this->idOfSupplier->setStdResult ( $idOfSupplierResult);
    		}
    		    	    		}
