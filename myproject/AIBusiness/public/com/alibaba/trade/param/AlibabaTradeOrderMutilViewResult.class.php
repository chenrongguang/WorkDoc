...
include_once ('com/alibaba/trade/param/AlibabaTradeOrderViewModel.class.php');
include_once ('com/alibaba/trade/param/AlibabaTradeReceiveAddress.class.php');
include_once ('com/alibaba/trade/param/AlibabaTradeResultCodeDef.class.php');
