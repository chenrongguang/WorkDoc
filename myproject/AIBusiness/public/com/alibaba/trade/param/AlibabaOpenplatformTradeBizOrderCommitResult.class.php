...
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeBizSimpleOrderModel.class.php');
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeResultCodeDef.class.php');
include_once ('com/alibaba/trade/param/AlibabaTradeComKeyValuePair.class.php');
