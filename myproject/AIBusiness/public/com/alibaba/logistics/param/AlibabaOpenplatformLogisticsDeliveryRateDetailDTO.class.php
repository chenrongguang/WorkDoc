...
include_once ('com/alibaba/logistics/param/AlibabaOpenplatformLogisticsDeliveryRateDTO.class.php');
include_once ('com/alibaba/logistics/param/AlibabaOpenplatformLogisticsDeliverySysRateDTO.class.php');
