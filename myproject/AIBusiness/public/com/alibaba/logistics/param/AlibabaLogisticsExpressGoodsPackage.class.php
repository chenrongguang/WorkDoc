...
include_once ('com/alibaba/logistics/param/AlibabaLogisticsExpressPackageItem.class.php');
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$packageItemsResult=$arrayResult['packageItems'];
    			$this->packageItems = new AlibabaLogisticsExpressPackageItem();
    			$this->packageItems->setStdResult ( $packageItemsResult);
    		}
    		    	    		}
