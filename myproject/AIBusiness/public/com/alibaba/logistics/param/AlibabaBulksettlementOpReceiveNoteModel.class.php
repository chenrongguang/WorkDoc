...
include_once ('com/alibaba/logistics/param/AlibabaBulksettlementOpReceiveNoteEntryModel.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->gmtReceive = $arrayResult['gmtReceive'];
    			}
    			...
    			$this->operatorUsername = $arrayResult['operatorUsername'];
    			}
    			...
    			$this->pcorpName = $arrayResult['pcorpName'];
    			}
    		...
    		$receiveEntrylistResult=$arrayResult['receiveEntrylist'];
