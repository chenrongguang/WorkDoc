...
include_once ('com/alibaba/logistics/param/AlibabaBulksettlementOpSpecItem.class.php');
include_once ('com/alibaba/logistics/param/AlibabaBulksettlementOpQuantityModel.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->receiveId = $arrayResult['receiveId'];
    			}
    		    	    			    		    			if (array_key_exists ( "statusInfo", $this->arrayResult )) {
    			$this->statusInfo = $arrayResult['statusInfo'];
    			}
    		    	    			    		    			if (array_key_exists ( "settlementOrderId", $this->arrayResult )) {
    			$this->settlementOrderId = $arrayResult['settlementOrderId'];
    			}
    			...
    			$this->productMaterialCode = $arrayResult['productMaterialCode'];
    			}
    		...
    		$specItemsResult=$arrayResult['specItems'];
    		...
    		$quantityModelResult=$arrayResult['quantityModel'];
    			    			$this->quantityModel = new AlibabaBulksettlementOpQuantityModel();
    			    			$this->quantityModel->setStdResult ( $quantityModelResult);
    		}
    		    	    		}
