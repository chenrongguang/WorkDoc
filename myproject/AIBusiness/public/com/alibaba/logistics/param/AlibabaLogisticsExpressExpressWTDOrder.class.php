...
include_once ('com/alibaba/logistics/param/AlibabaLogisticsCommonMoney.class.php');
...
include_once ('com/alibaba/logistics/param/AlibabaLogisticsExpressGoodsPackage.class.php');
include_once ('com/alibaba/logistics/param/AlibabaLogisticsCommonMoney.class.php');
include_once ('com/alibaba/logistics/param/AlibabaLogisticsExpressUserActionTrace.class.php');
include_once ('com/alibaba/logistics/param/AlibabaLogisticsExpressLogisticsTrackTrace.class.php');
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$userActionTracesResult=$arrayResult['userActionTraces'];
    			$this->userActionTraces = new AlibabaLogisticsExpressUserActionTrace();
    			$this->userActionTraces->setStdResult ( $userActionTracesResult);
    		}
    		    	    			    		    		if (array_key_exists ( "logisticsTrackTraces", $this->arrayResult )) {
    		$logisticsTrackTracesResult=$arrayResult['logisticsTrackTraces'];
    			$this->logisticsTrackTraces = new AlibabaLogisticsExpressLogisticsTrackTrace();
    			$this->logisticsTrackTraces->setStdResult ( $logisticsTrackTracesResult);
    		}
