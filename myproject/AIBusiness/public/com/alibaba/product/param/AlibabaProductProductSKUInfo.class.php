...
include_once ('com/alibaba/product/param/AlibabaProductSKUAttrInfo.class.php');
include_once ('com/alibaba/product/param/AlibabaProductProductPriceRange.class.php');
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$priceRangeResult=$arrayResult['priceRange'];
    			$this->priceRange = new AlibabaProductProductPriceRange();
    			$this->priceRange->setStdResult ( $priceRangeResult);
    		}
