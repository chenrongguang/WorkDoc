...
include_once ('com/alibaba/product/param/AlibabaProductSkuStockBean.class.php');
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$skuStocksResult=$arrayResult['skuStocks'];
    			$this->skuStocks = new AlibabaProductSkuStockBean();
    			$this->skuStocks->setStdResult ( $skuStocksResult);
    		}
    		    	    		}
