...
abstract class Connection
{
    ...
    public function execute_query($sql, $bind = [], $master = false, $pdo = false)
    {
        $this->initConnect($master);
        if (!$this->linkID) {
            return false;
    ...
    public function execute($sql, $bind = [])
    {
        ...
        try {
            ...
            if ( false === $result ) {
               // return false;
                throw new PDOException('s', $this->config, $this->getLastsql());
            } else {
            ...
            if ($this->isBreak($e)) {
                ...
                return $this->close()->execute_query($sql, $bind);
            }
            throw new PDOException($e, $this->config, $this->getLastsql());
        } catch (\Exception $e) {
            if ($this->isBreak($e)) {
