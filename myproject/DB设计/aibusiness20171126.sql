...
Source Database       : aibusiness

Target Server Type    : MYSQL
Target Server Version : 50547
File Encoding         : 65001

Date: 2017-11-26 00:26:10
*/
...
-- ----------------------------
INSERT INTO `ai_app_info` VALUES ('1', '4938940', 'q5HFMs0ZsE3s', 'AI运营-商品智能重发', 'http://218.60.42.138:11080/crgdev/callback/index.php', 'Y');
...
CREATE TABLE `ai_auth` (
  ...
  `expires_in` double DEFAULT NULL COMMENT 'access_token过期时间，单位秒',
